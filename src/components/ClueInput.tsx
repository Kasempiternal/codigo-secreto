  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="text-center mb-2">
        ...
        <p className="text-slate-400 text-xs sm:text-sm">Una palabra + número de cartas relacionadas</p>
      </div>
      ...
      >
        {loading ? (
          <>
            <svg className="w-4 h-4 sm:w-5 sm:h-5 spinner" fill="none" viewBox="0 0 24 24" stroke="currentColor">
